...
class Initializer {
  constructor() {
    ...
    if (document.readyState !== "loading") {
      ...
      document.addEventListener("DOMContentLoaded", self.onDocumentReady.bind(this), { once: true });
    }
  }
          ...
          newNodes.forEach((element) => {
            ...
            element.querySelector &&
              ...
              element.querySelectorAll(this.selectors.component).forEach((el) => {
                if (el.dataset && el.dataset.component && !el.dataset.initialized) {
  ...
  initComponent(el) {
    ...
    import(
      ...
      .catch((error) => {
        console.debug(`../${pathExtension}components/${componentName}/${componentName}.js not found`);
      });
  }
